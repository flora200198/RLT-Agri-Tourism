...
const BookingPage = () => {
  ...
  const handleBookingSubmit = (payload, type) => {
    if (type === 'adventure') {
      // Only total amount and guest count
      setBookingDetails({
        type,
        total: payload.details.total,
        numGuests: payload.details.numGuests
      });
    } else {
      setBookingDetails({ type, ...payload.details });
    }
            ...
            <div className="card shadow border-success">
              ...
              <div className="card-body text-center">
                ...
                <div className="alert alert-info text-start">
                  ...
                  {bookingDetails.type === 'adventure' && (
                    <>
                      <p><strong>Total Guests:</strong> {bookingDetails.numGuests}</p>
                    </>
                  )}
                </div>
  ...
  const AdventureForm = () => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      const total = pricing.adventure[formData.activity] * formData.numGuests;
      handleBookingSubmit({ details: { ...formData, total } }, 'adventure');
    };
